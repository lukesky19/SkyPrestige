...
public class SmeltItemListener extends PrestigePointsListener<FurnaceExtractEvent> {
    ...
    @Override
    protected void handle(@NotNull Settings settings, @NotNull IslandData islandData, @NotNull FurnaceExtractEvent furnaceExtractEvent, @NotNull EventContext eventContext) {
