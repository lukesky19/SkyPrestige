...
public class PlayerSleepListener extends PrestigePointsListener<PlayerDeepSleepEvent> {
    ...
    @Override
    protected void handle(@NotNull Settings settings, @NotNull IslandData islandData, @NotNull PlayerDeepSleepEvent playerDeepSleepEvent, @NotNull EventContext eventContext) {
        @Nullable BlockType blockType = eventContext.getBlockType();
        if(blockType == null) return;

        @Nullable Double prestigePoints = settings.prestigePointsMapping().getSleepPrestigePoints(blockType);
