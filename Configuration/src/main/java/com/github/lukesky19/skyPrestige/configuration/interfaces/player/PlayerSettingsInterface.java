...
*/
package com.github.lukesky19.skyPrestige.configuration.interfaces.player;
...
public interface PlayerSettingsInterface {
    /**
     * Get the {@link InventorySettingsInterface} for the player's inventory.
     * @return The {@link InventorySettingsInterface}.
     */
    @NotNull InventorySettingsInterface playerInventorySettings();

    /**
     * Get the {@link InventorySettingsInterface} for the player's ender chest.
     * @return The {@link InventorySettingsInterface}.
     */
    @NotNull InventorySettingsInterface playerEnderChestSettings();
    ...
    /**
     * Get the {@link PlayTimeSettingsInterface}.
     * @return The {@link PlayTimeSettingsInterface}
     */
    @NotNull PlayTimeSettingsInterface playTimeSettings();
}
