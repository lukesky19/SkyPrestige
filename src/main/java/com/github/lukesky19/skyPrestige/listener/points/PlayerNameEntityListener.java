 ...
 */
public class PlayerNameEntityListener extends PointsListener {
    /**
     * Constructor
    ...
    public void onPlayerNameEntity(PlayerNameEntityEvent playerNameEntityEvent) {
        ...
        // Player
        @NotNull Player player = playerNameEntityEvent.getPlayer();
        ...
        // Amount
        int amount = EntityUtils.getAmount(hookManager.getHook(RoseStackerHook.class), entity);

        // Points
        double points = prestigePointsManager.getEntityPoints(ActionType.NAME_ENTITY, prestigePointsConfig.prestigePointsMapping().nameEntity(), entityType);
        if(points <= 0) return;
