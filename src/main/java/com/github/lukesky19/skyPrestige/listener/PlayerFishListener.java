...
public class PlayerFishListener implements Listener {
    ...
    public void onPlayerFish(PlayerFishEvent playerFishEvent) {
        ...
        if(itemMeta instanceof PotionMeta potionMeta) {
            ...
            if(potionType != null) {
                @Nullable Double prestigePoints = settings.prestigePointsMapping().getFishPrestigePoints(itemType, potionType);
            ...
            @Nullable Double prestigePoints = settings.prestigePointsMapping().getFishPrestigePoints(itemType);
            ...
            for(Map.Entry<Enchantment, Integer> enchantmentEntry : enchantMeta.getStoredEnchants().entrySet()) {
                ...
                @Nullable Double prestigePoints = settings.prestigePointsMapping().getFishPrestigePoints(itemType, enchantment, level);
                if(prestigePoints != null) {
