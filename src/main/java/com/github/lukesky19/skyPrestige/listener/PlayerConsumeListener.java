...
public class PlayerConsumeListener implements Listener {
    ...
    public void onConsume(PlayerItemConsumeEvent playerItemConsumeEvent) {
        ...
        if(itemMeta instanceof PotionMeta potionMeta) {
            ...
            if(potionType != null) {
                @Nullable Double prestigePoints = settings.prestigePointsMapping().getConsumePrestigePoints(itemType, potionType);
    ...
    public void onCakeConsume(EntityChangeBlockEvent entityChangeBlockEvent) {
        ...
        ItemType itemType = blockType.getItemType();
        ...
        @Nullable Double prestigePoints = settings.prestigePointsMapping().consume().getItemPrestigePoints(itemType);
        if(prestigePoints == null) return;
