...
*/
package com.github.lukesky19.skyPrestige.listener.points.brewing;
...
public class FreshBrewListener implements Listener {
    ...
    public void onFreshBrew(BrewEvent brewEvent) {
        ...
        Optional<Island> optionalIsland = bentoBoxHook.getIslandAtLocation(brewEvent.getBlock().getLocation());
