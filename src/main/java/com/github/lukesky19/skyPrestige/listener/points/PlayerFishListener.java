 ...
 */
public class PlayerFishListener extends PointsListener {
    /**
     * Constructor
    ...
    public void onPlayerFish(PlayerFishEvent playerFishEvent) {
        ...
        // Player
        @NotNull Player player = playerFishEvent.getPlayer();
        ...
        // Points
        double points = prestigePointsManager.getItemPoints(ActionType.FISH, prestigePointsConfig.prestigePointsMapping().fish(), itemType, entityType, potionType, enchantments);
        if(points <= 0) return;
