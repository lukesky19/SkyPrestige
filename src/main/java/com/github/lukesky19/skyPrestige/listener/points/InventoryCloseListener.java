...
public class InventoryCloseListener extends PrestigePointsListener<InventoryCloseEvent> {
    ...
    @Override
    protected void handle(@NotNull Settings settings, @NotNull IslandData islandData, @NotNull InventoryCloseEvent inventoryCloseEvent, @NotNull EventContext eventContext) {
