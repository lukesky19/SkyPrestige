 ...
 */
public class PlayerStripLogListener extends PointsListener {
    /**
     * Constructor
    ...
    public void onPlayerStripLog(PlayerInteractEvent playerInteractEvent) {
        ...
        plugin.getServer().getScheduler().runTaskLater(plugin, () ->{
            ...
            if(!BlockUtils.isBlockTypeStripped(blockType)) return;
            ...
            // Points
            double points = prestigePointsManager.getBlockPoints(ActionType.STRIP, prestigePointsConfig.prestigePointsMapping().strip(), blockType, null, null, null);
            if(points <= 0) return;
