...
public class PlayerPickupItemListener implements Listener {
    ...
    public void onItemPickup(EntityPickupItemEvent entityPickupItemEvent) {
        ...
        if(itemMeta instanceof PotionMeta potionMeta) {
            ...
            if(potionType != null) {
                @Nullable Double prestigePoints = settings.prestigePointsMapping().getItemPickupPrestigePoints(itemType, potionType);
            ...
            @Nullable Double prestigePoints = settings.prestigePointsMapping().getItemPickupPrestigePoints(itemType);
            ...
            for(Map.Entry<Enchantment, Integer> enchantmentEntry : enchantMeta.getStoredEnchants().entrySet()) {
                ...
                @Nullable Double prestigePoints = settings.prestigePointsMapping().getItemPickupPrestigePoints(itemType, enchantment, level);
                if(prestigePoints != null) {
