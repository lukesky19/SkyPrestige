...
public class EconomyHook implements Hook {
     ...
     */
    public EconomyHook(@NotNull SkyPrestige skyPrestige) {
    ...
    public void initialize() {
        if(skyPrestige.getServer().getPluginManager().getPlugin("Vault") != null) {
            RegisteredServiceProvider<Economy> rsp = skyPrestige.getServer().getServicesManager().getRegistration(Economy.class);
            if (rsp != null) {
