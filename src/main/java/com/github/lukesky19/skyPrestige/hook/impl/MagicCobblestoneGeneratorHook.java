...
public class MagicCobblestoneGeneratorHook implements Hook {
     ...
     * Constructor
     */
    public MagicCobblestoneGeneratorHook() {}
    ...
    public void copyGeneratorData(@NotNull Island oldIsland, @NotNull Island newIsland) {
        ...
        @Nullable GeneratorDataObject newIslandData = stoneGeneratorManager.validateIslandData(newIsland);
        if(oldIslandData == null || newIslandData == null) return;
