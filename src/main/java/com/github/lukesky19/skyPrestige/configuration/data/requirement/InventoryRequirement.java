...
/**
 * This record holds the configuration for an inventory requirement.
 * @param scaleFormula The formula to scale player points.
 * @param scaleFactor The scale factor used in conjunction with the formula to scale the required player points.
 * @param item The required item configuration.
 * @param removeItem Should the required item be removed on prestige?
