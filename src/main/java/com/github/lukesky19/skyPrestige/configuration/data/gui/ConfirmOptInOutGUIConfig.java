...
/**
 * This record contains the configuration for the confirm opt-in/opt-out gui.
 ...
 */
@ConfigSerializable
public record ConfirmOptInOutGUIConfig(
     ...
     * @param keepEnderChest The {@link ButtonConfig} for the button shown when island member's ender chests are carried over on island reset.
