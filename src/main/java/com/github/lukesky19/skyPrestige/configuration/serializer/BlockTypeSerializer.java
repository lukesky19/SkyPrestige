...
/**
 * Serializes and deserializes {@link BlockType}.
 */
public class BlockTypeSerializer implements TypeSerializer<BlockType> {
     ...
     */
    public BlockTypeSerializer(@NotNull ComponentLogger logger) {
        this.logger = logger;
    }

    /**
     * Deserializes the {@link String} representing the {@link NamespacedKey} to a {@link BlockType}.
     * @param type The {@link Type}.
     * @param node The {@link ConfigurationNode} to deserialize.
     * @return The {@link BlockType} or null.
    ...
    public @Nullable BlockType deserialize(@NotNull Type type, @NotNull ConfigurationNode node) throws SerializationException {
        ...
        return RegistryUtil.getBlockType(logger, key).orElse(null);
    }

    /**
     * Serializes the {@link BlockType} to it's {@link NamespacedKey} as a {@link String}.
     * @param type The {@link Type}.
    ...
    public void serialize(@NotNull Type type, @Nullable BlockType blockType, @NotNull ConfigurationNode node) throws SerializationException {
        ...
        node.set(String.class, blockType.getKey().toString());
    }
}