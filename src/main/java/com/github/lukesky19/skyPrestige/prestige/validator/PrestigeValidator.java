...
public class PrestigeValidator {
    ...
    // BentoBox
    private final @NotNull AddonsManager addonsManager;
    ...
    public PrestigeValidator(
        ...
        this.addonsManager = bentoBox.getAddonsManager();
    ...
    public @Nullable GameModeAddon validateGameModeAddon(@NotNull Player player) {
        ...
        @NotNull Optional<GameModeAddon> optionalGameModeAddon = addonsManager.getGameModeAddons().stream()
                .filter(gameModeAddon -> gameModeAddon.inWorld(playerWorld))
                .findFirst();
    ...
    public boolean isPlayerIslandOwnerOrMember(@NotNull Player player, @NotNull Island island) {
        ...
        if(island.getOwner() != null) {
            isOwnerOrMember = island.getOwner().equals(playerId) || island.getMembers().containsKey(playerId);
        } else {
            isOwnerOrMember = island.getMembers().containsKey(playerId);
        }
    ...
    public @Nullable PrestigeConfig validatePrestigeConfig(@NotNull Player player, int prestigeLevel) {
        ...
        @Nullable PrestigeConfig prestigeConfig = prestigeConfigManager.getPrestigeConfig(prestigeLevel);
