...
*/
package com.github.lukesky19.skyPrestige.island.data;
...
public class IslandData implements Cloneable {
    ...
    /**
     * Clear the {@link ItemStack}s in the island's vault for the page number provided.
     * @param pageNum The page number.
     */
    public void clearVaultItems(int pageNum) {
        vaultItems.keySet().removeIf(pageSlotKey -> pageSlotKey.page() == pageNum);
    }
