...
*/
package com.github.lukesky19.skyPrestige.commands.shared;

import com.github.lukesky19.skyPrestige.commands.util.IslandArgumentType;
import com.github.lukesky19.skyPrestige.configuration.data.locale.Locale;
import com.github.lukesky19.skyPrestige.configuration.manager.LocaleManager;
import com.github.lukesky19.skyPrestige.dialog.dialogs.server.multiplier.ServerMultiplierDialog;
    ...
    public @NonNull LiteralCommandNode<CommandSourceStack> createCommand() {
        ...
        builder.then(Commands.literal("server")
            ...
            .then(Commands.literal("dialog")
                .requires(ctx -> ctx.getSender().hasPermission("skyprestige.commands.skyprestige.multiplier.server.dialog"))
                .executes(ctx -> {
                    Player player = (Player) ctx.getSource().getSender();

                    Dialog dialog = ServerMultiplierDialog.createDialog(dialogManager, multiplierManager, player);
