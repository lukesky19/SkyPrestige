...
*/
package com.github.lukesky19.skyPrestige.leaderboard.manager;
...
public class LeaderboardManager {
    ...
    public LeaderboardManager(
        ...
        this.server = skyPrestige.getServer();
    ...
    public void updateTopTen() {
        ...
        @NotNull Map<String, IslandData> loadedIslandData = islandDataManager.getIslandData();
