...
public class PlayerBucketFillListener extends PrestigePointsListener<PlayerBucketFillEvent> {
    ...
    @Override
    protected void handle(@NotNull Settings settings, @NotNull IslandData islandData, @NotNull PlayerBucketFillEvent playerBucketFillEvent, @NotNull EventContext eventContext) {
