...
/**
 * This class manages the {@link DialogInput} to set the island's multiplier.
 */
public class IslandMultiplierInput {
    /**
     * Default Constructor
     */
    public IslandMultiplierInput () {}

    /**
     * Create the input to set the island's multiplier.
    ...
    public static @NonNull DialogInput createInput(@NonNull IslandDialog islandDialog) {
        return DialogInput.text("island_multiplier", AdventureUtility.plain("Prestige Point Multiplier"))
                .labelVisible(true)
                .initial(String.valueOf(islandDialog.getMultiplier()))
                .maxLength(50)
                .width(300)
                .build();
    }
