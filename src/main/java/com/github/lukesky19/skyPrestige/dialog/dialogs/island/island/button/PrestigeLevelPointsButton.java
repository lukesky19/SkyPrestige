...
import com.github.lukesky19.skyPrestige.dialog.dialogs.island.prestige.PrestigeDialog;
...
/**
 * This class manages the {@link ActionButton} to open the prestige level and points dialog.
 */
public class PrestigeLevelPointsButton {
    /**
     * Default Constructor
     */
    public PrestigeLevelPointsButton () {}

    /**
     * Create the button to open the prestige level and points dialog.
    ...
    public static @NonNull ActionButton createButton(
        ...
        return ActionButton.create(
                AdventureUtility.plain("Prestige Level & Points"),
                null,
                150,
                DialogAction.customClick(
                        (_, _) -> {
                            ...
                            Dialog dialog = PrestigeDialog.createDialog(dialogManager, prestigeConfigManager, player, islandDialog, islandIdentifier);
