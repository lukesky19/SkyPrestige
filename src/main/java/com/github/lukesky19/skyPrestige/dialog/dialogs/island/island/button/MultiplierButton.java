...
import com.github.lukesky19.skyPrestige.dialog.dialogs.island.multiplier.IslandMultiplierDialog;
...
/**
 * This class manages the {@link ActionButton} to open the multiplier dialog.
 */
public class MultiplierButton  {
    /**
     * Default Constructor
     */
    public MultiplierButton () {}

    /**
     * Create the button to open the multiplier dialog.
    ...
    public static @NonNull ActionButton createButton(
        ...
        return ActionButton.create(
                AdventureUtility.plain("Multiplier"),
                null,
                150,
                DialogAction.customClick(
                        (_, _) -> {
                            ...
                            Dialog dialog = IslandMultiplierDialog.createDialog(dialogManager, multiplierManager, player, islandDialog, islandIdentifier);
