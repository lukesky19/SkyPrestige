...
/**
 * This class manages the {@link ActionButton} to close the dialog, discarding any changes.
 */
public class DiscardButton {
    ...
    /**
     * Create the button to close the dialog and discard any inputs.
    ...
    public static @NonNull ActionButton createButton(
        ...
        return ActionButton.create(
                AdventureUtility.deserialize("<#f16262>Discard Changes"),
                null,
                150,
