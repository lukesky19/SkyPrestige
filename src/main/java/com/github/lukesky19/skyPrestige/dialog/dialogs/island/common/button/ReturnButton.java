...
/**
 * This class manages the {@link ActionButton} to close the dialog and return to the main menu.
 */
public class ReturnButton {
    ...
    /**
     * Create the button to close the dialog and return to the main menu.
    ...
    public static @NonNull ActionButton createButton(
        ...
        return ActionButton.create(
                AdventureUtility.plain("Return to Main Menu"),
                null,
                150,
