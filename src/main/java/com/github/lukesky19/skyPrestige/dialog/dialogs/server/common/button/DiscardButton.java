...
*/
package com.github.lukesky19.skyPrestige.dialog.dialogs.server.common.button;
...
/**
 * This class manages the {@link ActionButton} to close the dialog, discarding any inputs.
 */
public class DiscardButton {
    ...
    /**
     * Create the button to close the dialog, discarding any inputs.
