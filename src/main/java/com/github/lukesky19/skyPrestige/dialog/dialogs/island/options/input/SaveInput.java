...
/**
 * This class manages the {@link DialogInput} to choose whether to save changes to the database or not after review.
 */
public class SaveInput {
    ...
    /**
     * Create the input to choose whether to save changes to the database or not after review.
    ...
    public static @NonNull DialogInput createInput(@NonNull IslandDialog islandDialog) {
        return DialogInput.bool("save", AdventureUtility.plain("Save Island Data to the Database"))
                .initial(islandDialog.isPrestigeExempt())
                .onTrue("Save Island Data")
                .onFalse("Do Not Save Island Data")
                .build();
    }
}