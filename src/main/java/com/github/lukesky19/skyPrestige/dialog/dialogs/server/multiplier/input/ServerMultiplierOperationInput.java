...
/**
 * This class manages the {@link DialogInput} to for choosing a server multiplier operation.
 */
public class ServerMultiplierOperationInput {
    /**
     * Default Constructor
     */
    public ServerMultiplierOperationInput () {}
    ...
    public static @NonNull DialogInput createInput() {
        return DialogInput.singleOption(
                "server_multiplier_operation",
                300,
                Operation.createDialogEntries(),
                AdventureUtility.plain("Select a Server Multiplier Operation"),
                true);
    }
}