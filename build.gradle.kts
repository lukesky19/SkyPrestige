...
dependencies {
    ...
    testImplementation("world.bentobox:level:2.8.1-SNAPSHOT") // Required for mocking classes from MagicCobblestoneGenerator
    testImplementation("world.bentobox:bank:1.9.0-SNAPSHOT") // Required for mocking classes from MagicCobblestoneGenerator
